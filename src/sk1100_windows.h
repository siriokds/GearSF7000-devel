// SC-3000 host keyboard mapping for Windows and non-macOS desktop builds.
// Included by sk1100.cpp after t_sk1100_key has been declared.

#ifndef SK1100_WINDOWS_MAPPING_H
#define SK1100_WINDOWS_MAPPING_H

static const t_sk1100_key SK1100_KeyboardMode_Mapping[] =
{
    // Y7: joystick 1 remains available through the numeric keypad.
    ...
    { SDL_SCANCODE_APPLICATION, 0, 16, 0, "ENG" },
    ...
    { SDL_SCANCODE_HOME, 2, 16, 0, "Home/Clear" },
