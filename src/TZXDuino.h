...
PROGMEM const char ZX81Filename[9] = { 'T','Z','X','D','U','I','N','O',(char)0x9D };
PROGMEM const char AYFile[8] = { 'Z','X','A','Y','E','M','U','L' }; // added additional AY file header check
PROGMEM const char TAPHdr[20] = { 0x0,0x0,0x3,'Z','X','A','Y','F','i','l','e',' ',' ',0x1A,0xB,0x0,(char)0xC0,0x0,(char)0x80,0x6E }; // 
...
//TZX File Tasks
#define TZX_FILE_GETTZXHEADER         0
#define TZX_FILE_GETID                 1
#define TZX_FILE_PROCESSID             2
#define TZX_FILE_GETAYHEADER           3
#define TZX_FILE_GETUEFHEADER          4
#define TZX_FILE_GETCHUNKID            5
#define TZX_FILE_PROCESSCHUNKID        6

//TZX ID Tasks
#define TZX_TASK_READPARAM             0
#define TZX_TASK_PILOT                 1
#define TZX_TASK_SYNC1                 2
#define TZX_TASK_SYNC2                 3
#define TZX_TASK_DATA                  4
#define TZX_TASK_PAUSE                 5
#define TZX_TASK_HEADER                6
#define TZX_TASK_NAME                  7
#define TZX_TASK_GAP                   8
#define TZX_TASK_SYNCLAST              9
#define TZX_TASK_NAMELAST              10

//Buffer size
#define buffsize              64

//Spectrum Standards
#define ZXSPECTRUM_PILOTLENGTH           619
#define ZXSPECTRUM_SYNCFIRST             191
#define ZXSPECTRUM_SYNCSECOND            210
#define ZXSPECTRUM_ZEROPULSE             244
#define ZXSPECTRUM_ONEPULSE              489
#define ZXSPECTRUM_PILOTNUMBERL          8063
#define ZXSPECTRUM_PILOTNUMBERH          3223
#define ZXSPECTRUM_PAUSELENGTH           1000   
