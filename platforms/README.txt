...
https://github.com/drhelius/GearSF7000
-----------------------------------------------------
GearSF7000 is a very accurate cross-platform ColecoVision emulator written in C++ that runs on Windows, macOS, Linux, BSD and RetroArch.
...
-----------------------------------------------------
GearSF7000 is licensed under the GNU General Public License v3.0 License:
