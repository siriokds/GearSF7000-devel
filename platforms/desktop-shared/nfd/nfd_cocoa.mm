...
nfdresult_t NFD_OpenDialogN_With_Impl(nfdversion_t version,
    ...
    @autoreleasepool {
        ...
        // macOS has no public UTI for the emulator's .bit/.bas tape images.
        // Keep the suggested filter, but allow an explicitly chosen file so
        // custom and upper-case extensions do not become impossible to load.
