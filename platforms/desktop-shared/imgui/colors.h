...
// dark_gray at full alpha reads as solid black once drawn as a 1px line over
// a colorful sprite/tile image - fine as a UI separator, wrong as a grid
// overlay meant to sit on top of the picture without hiding it.
static const ImVec4 grid_line =     ImVec4(0.50f, 0.50f, 0.50f, 0.35f);
